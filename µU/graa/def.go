...
// All edges outgoing from the local vertex of x
// are inserted into the subgraph of x;
// but neither any neighbour of the local vertex
// nor any edge between two of its neighbours.
  Sub1()
