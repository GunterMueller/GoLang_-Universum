...
// For e == nil e is replaced by uint(1). // XXX
  Edge (e edg.Edge)
...
// and e is inserted is an edge from v to v1.
  Edge2 (v, v1 vtx.Vertex, e edg.Edge)
...
func New (d bool, v vtx.Vertex, e edg.Edge) Graph { return new_(d,v,e) }
