...
// If i or k >= x.Num(), nothing has happened.
// Otherwise: x(i,k) == (v, e).
  Set (i, k uint, v vtx.Vertex, e edg.Edge)
...
// (v, e).
func New (n uint, v vtx.Vertex, e edg.Edge) AdjacencyMatrix { return new_(n,v,e) }
