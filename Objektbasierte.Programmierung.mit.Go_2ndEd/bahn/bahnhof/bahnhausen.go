...
//         |     |    |   |  |   |   |    |   |    |     |    |   |    |   Spalte
//         |     |    |   |  |   |   |    |   |    |     |    |   |    |     |
  x.gleis ( 1, b.Dfg, G, 16, 7, 13, 21, s.NT, k, s.NS,   1, s.T2, m, s.Hp0, 29)
  x.gleis ( 2, b.Dfg, G, 18, 6, 12, 21, s.NT, k, s.Hp0,  2, s.T2, m, s.Hp0, 29)
  x.gleis ( 3, b.Dfg, G, 18, 5, 12, 21, s.T1, g, s.Hp0, 13, s.NT, k, s.Hp0,  0)
  x.gleis ( 4, b.Dfg, G, 16, 4, 13, 21, s.T2, g, s.Hp0, 13, s.NT, k, s.NS,   0)
  x.gleis (12, b.EfM, G, 11, 6,  0,  5, s.NT, k, s.NS,  31, s.T1, m, s.Hp0, 11)
  x.gleis (13, b.AfG, G, 11, 5,  0,  5, s.T1, g, s.Hp0,  0, s.NT, k, s.Hp0, 11)
  x.gleis (14, b.AsG, G, 10, 4,  2,  5, s.NT, k, s.NS,   0, s.T1, m, s.Hp0, 11)
  x.gleis (21, b.AsM, G, 10, 7, 30, 36, s.T1, g, s.Hp0, 31, s.NT, k, s.NS,   0)
  x.gleis (22, b.AfM, G, 11, 6, 31, 36, s.NT, k, s.Hp0, 31, s.T1, m, s.Hp0, 41)
  ...
  nachbar[12] = netz.Bahnheim
  nachbar[13] = netz.Bahnheim
  nachbar[22] = netz.Bahnstadt
  nachbar[23] = netz.Bahnstadt
