...
func Cube (p pts.Points, x, y, z, a float64, c col.Colour) { cube(p,x,y,z,a,c) }

func CubeC (p pts.Points, x, y, z, a float64, c []col.Colour) { cubeC(p,x,y,z,a,c) }

func Cuboid (p pts.Points, x0, y0, z0, x1, y1, z1 float64, c col.Colour) { cuboid(p,x0,y0,z0,x1,y1,z1,c) }

func CuboidC (p pts.Points, x0, y0, z0, x1, y1, z1 float64, c []col.Colour) { cuboidC(p,x0,y0,z0,x1,y1,z1,c) }
