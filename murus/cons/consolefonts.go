...
// (c) Christian Maurer   v. 140129 - license see murus.go
...
var (
  f07[256][ 7]string
  f10[256][10]string
  f16[256][16]string // lat9w-16
  f24[256][24]string // xos4-terminus-bold-24
  f32[256][32]string // xos4-terminus-bold-32
)

func pointed (s font.Size, b byte, l, c uint) bool {
  switch s { case font.Tiny:
    return f07[b][l][c] != ' '
  case font.Small:
    return f10[b][l][c] != ' '
  case font.Normal:
