...
import (
  "math"
  "murus/ker"; "murus/spc"; "murus/env"; "murus/col"; "murus/scr"; "murus/vect"
)
const
  nLamp = 12
var (
...
//  q:= C.GLdouble(0.75)
//  GLFrustum (-1.0 * near, 1.0 * near, -q * near, q * near, 1.0 * near, C.GLdouble(far))
...
func write (f Figure, a uint, V, N []vect.Vector, c col.Colour) {
