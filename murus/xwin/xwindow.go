...
// (c) Christian Maurer   v. 170827 - license see murus.go
...
//       pointer ptr.Pointer
      ...
      subWindows []C.Window
         A, B, C,
      dx, dy, dz C.GLfloat // only for openGL
                 }
var (
...
*/
  ...
  C.glLoadIdentity()
  near, far := C.GLdouble(0.2), C.GLdouble(500)
  bottom, top := -0.75 * near, 0.75 * near
  C.glFrustum (-near, near, bottom, top, near, far)
