...
func (x *calendarday) Actualize() {
  x.day, x.month, x.year = ActualizeDate()
}
...
func (x *calendarday) weekday() Weekday {
  return Weekday((x.internalCode() + uint16(Wednesday)) % 7)
...
//  switch x.Format { case W, M, Dd_M_yyyy:
