...
func MaxMode() mode.Mode { return maxMode() }

// Returns the (X, Y)-resolution of the screen in pixels (= Size(MaxMode()).
func MaxRes() (uint, uint) { return maxRes() }
func MaxX() uint { return maxX() }
func MaxY() uint { return maxY() }
...
// Returns the number of screens generated by New or NewMax.
func N() uint { return n() }

// Pre: i < N()
// Returns the i-th by New or NewMax generated screen, which is now the actual one.
// func Scr (i uint) Screen { return scr_(i) }

// Returns the actual screen.
func Act() Screen { return act() }

// TODO Spec
// If UnderX, nothing had happened; if not,
// the actual screen now has number 0.
// func Circulate() { circulate() }

// Returns the number of the actual screen.
// Scr (NAct()) == Act().
